...
export class AssetLoader {
  ...
  loadStyle(content: string | undefined | null, level: AssetLevel, isUrl?: boolean, id?: string) {
    if (!content) {
      return;
    }
  ...
  loadScript(content: string | undefined | null, isUrl?: boolean, scriptType?: string) {
    if (!content) {
      return;
    }
